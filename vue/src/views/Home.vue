...
import TidesAssistantIcon from '../components/icons/TidesAssistantIcon.vue'
import TidesAssistantRobotIcon from '../components/icons/TidesAssistantRobotIcon.vue'
import TidesAnalysisIcon from '../components/icons/TidesAnalysisIcon.vue'
...
const aiApps = ref([
  {
    id: 1,
    title: '潮声贴心助手',
    description: '帮你解决潮声业务相关的问题',
    route: '/tides-ai',
    icon: TidesAssistantRobotIcon
  },
  {
    id: 2,
    title: '潮声规则助手',
    description: '帮你解决潮声规则相关的问题',
    route: '/tides-rag',
    icon: TidesAssistantIcon
  },
  {
    id: 3,
    title: '潮声运维助手',
    description: '日志查询、链路追踪、系统监控分析',
    route: '/tides-analysis',
    icon: TidesAnalysisIcon
  },
  {
    id: 4,
    title: 'AI可观测性',
